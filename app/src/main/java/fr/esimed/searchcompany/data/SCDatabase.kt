...
abstract class SCDatabase: RoomDatabase() {
    ...
    fun seed(){
        ...
        if (searchDao.count()==0)
        {
            ...
            companyDao.insert(Company(null,"company1","84","chezmoi","rien faire","245210","2021/01/24"))
            companyDao.insert(Company(null,"company1","84","chezmoi","rien faire","245212","2021/01/24"))
            val KCSDao=kcsDAO()
